...
public class CriarContaSteps {
    ...
    AuthenticationPage preCadastro = new AuthenticationPage();
    ...
    public void que_estou_na_tela_de_pré_cadastro() throws Throwable {
        preCadastro.validaPaginaAutenticacao();
    }

    @And("^insiro um email valido$")
    public void insiro_um_email_valido() throws Throwable {
        preCadastro.digiteEmailValido();
        preCadastro.cliqueNoBotaoLogarHome();
    }

    @When("^redirecionar para a tela seguinte$")
    public void redirecionar_para_a_tela_seguinte() throws Throwable {
